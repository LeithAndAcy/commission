								...
								<div class="col-sm-8">
									<div class="form-group">
										...
										<div class="col-sm-6 input-group date form_datetime" data-date-format="yyyy-mm-dd">
											<input type="text" class="form-control" name="begin_date" id="begin_date" readonly="" >
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="form-horizontal" role="form">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">存货类别</label>
									<div class="col-sm-6">
						...
						<div class="modal-body">
							<div class="form-group">
								...
								<div class="col-sm-6 input-group" style="padding-left: 15px;padding-right: 14px" >
									<input type="text" name="edit_business_adjust" id="edit_business_adjust" class="form-control validate[required,[custom[number],min[0]]">
