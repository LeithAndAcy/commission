...
<script>
	...
	<body>
		<div class="col-xs-12">
			<div>
				<form class="form-inline" enctype="multipart/form-data" method="post" action="/commission/index.php/Home/Excel/loadNormalProfitExcel">
					<div class="form-group">
						<a><li data-toggle="modal" data-target="#addNew" class="btn btn-info">新增</li></a>
					</div>
					<div class="form-group">
						<input type="file" id="normal_profit_ratio_excel" name="normal_profit_ratio_excel" class="btn btn-info" value="导入Excel文件" />
					</div>
					<div class="form-group">
