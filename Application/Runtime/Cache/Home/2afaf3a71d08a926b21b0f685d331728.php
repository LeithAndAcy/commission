...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<ul id="myTab" class="nav nav-pills nav-stacked" role="tablist">
		<li role="presentation">
			<a href="/commission/index.php/Home/SearchData/CaculatBusinessAndProfit" target="workflow">业绩利润汇总</a>
		</li>
		<li role="presentation">
			<a href="/commission/index.php/Home/SearchData/SearchBusinessData" target="workflow">业务数据查询</a>
		</li>
	</ul>
...
<script>
	...
	<script>
		$(function(){
			$("[li_function='SearchData']").addClass("active");
