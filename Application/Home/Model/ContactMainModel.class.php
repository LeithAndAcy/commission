...
class ContactMainModel extends Model {
	...
	public function getSettlingContactDetail(){
		...
		commission_contact_detail.custom_fee,commission_contact_detail.coreColour,commission_contact_detail.inStore,
	...
	public function getSettledContactDetail($begin_date,$end_date){
		...
		commission_contact_detail.gm_ratio * 100 as gm_ratio,commission_contact_detail.skill_ratio * 100 as skill_ratio,
		commission_contact_detail.gm_price,commission_contact_detail.skill_price,
		...
		commission_contact_detail.coreColour,commission_contact_detail.inStore,
		commission_contact_detail.sale_price,commission_contact_detail.cost_price,commission_contact_detail.float_price,
		...
		commission_contact_detail.special_business,commission_contact_detail.normal_profit,
		commission_contact_detail.normal_profit_1,commission_contact_detail.normal_profit_2,
		commission_contact_detail.end_cost_price,
