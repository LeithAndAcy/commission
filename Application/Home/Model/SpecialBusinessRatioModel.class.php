...
class SpecialBusinessRatioModel extends Model {
	...
	public function getAllSpecialBusinessRatio() {
		...
		$res = $this -> query("select id,salesman_id,classification_id,ratio,ltrim(str(low_limit,12,2)) as low_limit,ltrim(str(high_limit,12,2)) as high_limit from commission_special_business_ratio");
